...
import com.example.a15.adapters.Adapter4x4
...
import com.example.a15.databinding.ActivityGame4x4Binding
import kotlin.math.roundToInt

@Suppress("DEPRECATION")
class Game4x4 : AppCompatActivity(), ItemChangeListener {
    private lateinit var binding: ActivityGame4x4Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityGame4x4Binding.inflate(layoutInflater)
        ...
        val time = intent.getIntExtra("time4x4", 0)
        val nextAction = intent.getBooleanExtra("nextAction4x4", false)
        downSeconds = time * 60
